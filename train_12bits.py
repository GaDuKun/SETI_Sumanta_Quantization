...
import keras_model_quant_12bits as keras_model
...
if __name__ == "__main__":
    ...
    model_name = "trainedResnet_quant_12bits"
    ...
    #plt.savefig("Accurary_Loss_"+ model_name +".png")
    model_file = model_name + ".h5"
    new_model.save("trained_models/" + model_file)
